...
![Configuration Hosts](https://github.com/meshkov-sergey/8-02-hw/blob/main/img/zabbix-configuration-hosts.png) - Раздел Hosts с подключенными агентами

![Local Agent Logs](https://github.com/meshkov-sergey/8-02-hw/blob/main/img/zabbix-agent-logs-local.png) - Логи локального агента (подключение к серверу)

![Docker Agent Logs](https://github.com/meshkov-sergey/8-02-hw/blob/main/img/zabbix-agent-logs-docker.png) - Логи Docker агента (подключение к серверу)

![Latest Data](https://github.com/meshkov-sergey/8-02-hw/blob/main/img/zabbix-monitoring-latest-data.png) - Latest data с данными от обоих агентов
